...
#define MODULE_VERSION_SVN "$Id: telnet.c 1580 2011-07-07 21:31:21Z jmk $"
...
int tryLoginAS400(int hSocket, sLogin** login, _MODULE_DATA* _psSessionData, char* szLogin, char* szPassword);
int initModule(sLogin* login, _MODULE_DATA* _psSessionData);
int processIAClogout(int hSocket, _MODULE_DATA* _psSessionData);
void processIAC(int hSocket, _MODULE_DATA* _psSessionData, char** buffer, int* nBufferSize);
