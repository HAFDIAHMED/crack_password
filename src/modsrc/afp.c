...
#define MODULE_VERSION_SVN "$Id: afp.c 1301 2010-02-09 22:54:18Z jmk $"
...
void stdout_log_for_medusa(void * priv, enum loglevels loglevel, int logtype, const char *message)
{
